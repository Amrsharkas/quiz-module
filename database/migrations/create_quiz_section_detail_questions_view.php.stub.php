...
class CreateQuizSectionDetailQuestionsView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('DROP table IF EXISTS quiz_section_detail_questions');
    ...
    {
        DB::unprepared('DROP view quiz_section_detail_questions');
    }
}
