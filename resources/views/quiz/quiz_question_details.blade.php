<div class="input-40px-height question_details">
    ...
    <div class="d-flex align-items-center mt-3">
        <div class="row col">
            <div class="col-3 pl-0 d-flex align-items-center">
                ...
                <input type="text" name="number_of_questions_{{$quiz_section_detail->id}}" value="{{$quiz_section_detail->number}}">
            </div>

            <div class="col-9 d-flex align-items-center">
                <label class="mr-2 mb-0 min-w-100px">Difficulty</label>
                <select name="difficulty_{{$quiz_section_detail->id}}" class="select2" multiple>
        ...
        <div>
            <a id="{{$quiz_section_detail->id}}" type="button" class="btn delete_unit_btn_style btn-40px px-0 pb-0 pt-1 remove_quiz_section_detail" data-action="{{route('admin.quiz.delete_quiz_section_detail',['quiz_section_detail_id'=>$quiz_section_detail->id])}}" data-confirm="1" data-role="AssessmentContainerForm">
    ...
    <div class="d-flex align-items-center mt-2">
        ...
        <select name="question_type_{{$quiz_section_detail->id}}" class="select2" multiple>
