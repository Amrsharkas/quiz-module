...
use mennaAbouelsaadat\quizGenerator\Models\CGPQuestionChoice;
use mennaAbouelsaadat\quizGenerator\Models\CGPQuizEntry;
use mennaAbouelsaadat\quizGenerator\Models\CGPQuizGenerator;
use Auth;
use Illuminate\Http\Request;

//uses
class CGPQuizGeneratorController extends Controller
{
